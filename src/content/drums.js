...
export default [
...

  {
    type: '9P',
    key: 'PanBCelticMinor',
    title: 'Pan B Celtic Minor',
    description: 'The ding of our PAN Celtic B is tuned in B2, and the Heartbeats for B Celtic is tuned in B1 so the music of B Celtic is smooth, ambient, low and soothing. Let PAN Celtic B in your heart.',
    descriptionRu: 'Динг нашего PAN Celtic B настроен на ноту B2. Он ниже, чем большинство handpan, которые вы когда-либо видели. У него низкий и неподражаемый басовый звук. У нашего пэна есть сердце - Heartbeats Sound. Этот воздушный диффузор - неотъемлемая часть новых инструментов. Он обеспечивает правильную циркуляцию воздуха внутри инструмента, увеличивает сустейн и делает звук плотным и четким, как биение сердца.',
    notesString: 'B2 F#3 A3 B3 C#4 D4 E4 F#4 A4',
    notes: [
      {
        key: 'F%233',
    ...
    combinesWith: [
      { type: '10', key: 'DCelticMinor', title: 'D Celtic Minor' },
      { type: '9', key: 'BCelticMinor', title: 'B Celtic Minor' },
    ],
    demo: [],
  },

  {
    type: '9P',
    key: 'PanDCelticMinor',
    title: 'Pan D Celtic Minor',
    description: 'RAV Pan Celtic D is your first handpan. No compromise, only the beloved sound of handpan. It is very easy to learn and combine notes with it. Heartbeat is D2 will make your music even more vibrant.',
    descriptionRu: 'RAV Pan Celtic D - ваш первый handpan. Если вы всегда хотели играть на handpan и не любите компромиссы, то эта настройка сделана для вас. У нашего пэна есть сердце - Heartbeats Sound. Этот воздушный диффузор - неотъемлемая часть новых инструментов. Он обеспечивает правильную циркуляцию воздуха внутри инструмента, увеличивает сустейн и делает звук плотным и четким, как биение сердца.',
    notesString: 'D3 A3 C4 D4 E4 F4 G4 A4 C5',
    notes: [
      {
        key: 'A3',
...

  {
    ...
    key: 'PanFPygmy',
    title: 'Pan F Pygmy',
    description: 'RAV Pan is a handpan produced by RAV Labs, - 11 membranes including 2 bottom notes intricately tuned to produce electric and vibrating sound. F Pygmy feels like something that you need to discover.',
    descriptionRu: 'F Pygmy - это наше видение handpan. Две дополнительные ноты на нижней части инструмента добавляют в классический звук пэна нечто особенное. Сложно остаться равнодушным к F Pygmy. Сбалансированность этой настройки определяет её универсальность. Выразительное, но спокойное звучание.',
    notesString: 'F3 G3 G#3 C4 D#4 F4 G4 G#4 C5 C#3 D#3',
    notes: [
      {
        key: 'G3',
        name: 'G3',
  ...
  },
  {
    ...
    combinesWith: [
      { type: '9', key: 'DBlues', title: 'D Blues' },
  ...
  },
  {
    ...
    key: 'DBlues',
    title: 'D Blues',
    description: 'The atmosphere created with this scale is romantic, passionate, even intimate. Based on a traditional blues gamma this RAV has a mysterious deep sound that carries dynamics as well as tension.',
    descriptionRu: 'В основе D Blues лежит классическая блюзовая гамма: минорная пентатоника с добавлением пониженных пятой и седьмой ступени.',
    notesString: 'D3 F3 G3 A3 D4 G4 G#4 F4 C4 G#3',
    notes: [
      {
        key: 'F3',
        name: 'F3',
    ...
    combinesWith: [
      { type: '10', key: 'CBlues', title: 'C Blues' },
      { type: '9', key: 'DMajor', title: 'D Major' },
      { type: '9', key: 'BRus', title: 'B Rus' },
    ],
    demo: [],
  ...
  },
  {
    ...
    key: 'FInSen',
    title: 'F In Sen',
    description: 'This is the scale with the highest voice ever created by RAV Vast. The In Sen’s sonorous clean voice reminds of wind chimes.',
    descriptionRu: 'Японская пентатоника. Инструмент с пронзительным и ярким звуком. Звонкая и при этом гармоничная настройка определенно понравится любителям азиатской культуры.',
    notesString: 'F#3 G3 B3 E4 G4 C#5 E5 B4 F#4 C#4',
    notes: [
      {
        key: 'G3',
        name: 'G3',
    ...
    combinesWith: [
      { type: '9', key: 'GMinorPentatonic', title: 'G Minor Pentatonic' },
      { type: '9', key: 'DCelticMinor', title: 'D Celtic Minor' },
      { type: '11', key: 'PanFPygmy', title: 'Pan F Pygmy' },
    ],
    demo: [],
  },
  {
